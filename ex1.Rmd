...
While the general trend shows that as the quantity of one base increases, the quantity of the other decreases, when comparing A to T and C to G, we observe something interesting. For these two pairs, as the amount of one base increases, so does the amount of the other. The cells where the quantities of C and G are relatively high are mostly located in the two central quarters of the chromosome. The cells with relatively high quantities of A and T are found in the first three quarters of the chromosome and almost not at the end.
